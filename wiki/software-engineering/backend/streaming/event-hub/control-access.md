...
## Authorize access with managed identities <a href="#authorize-access-with-managed-identities" id="authorize-access-with-managed-identities"></a>
...
## Authorize access to Event Hubs publishers with shared access signatures <a href="#authorize-access-to-event-hubs-publishers-with-shared-access-signatures" id="authorize-access-to-event-hubs-publishers-with-shared-access-signatures"></a>
...
## Authorize access to Event Hubs consumers with shared access signatures <a href="#authorize-access-to-event-hubs-consumers-with-shared-access-signatures" id="authorize-access-to-event-hubs-consumers-with-shared-access-signatures"></a>
